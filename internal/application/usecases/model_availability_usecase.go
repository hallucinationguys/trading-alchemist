...
func (uc *ModelAvailabilityUseCase) GetAvailableModelsWithAPIKeyStatus(ctx context.Context, userID uuid.UUID) ([]dto.ProviderResponse, error) {
	...
	for i, provider := range providers {
		models := make([]dto.ModelResponse, len(provider.Models))
