...
func ToProviderResponse(p *chat.Provider) ProviderResponse {
...
func ToUserProviderSettingResponse(setting *chat.UserProviderSetting, provider *chat.Provider) UserProviderSettingResponse {
...
// ToModelResponse converts an chat.Model to a ModelResponse DTO.
func ToModelResponse(m *chat.Model) ModelResponse {
...
// ToModelResponses converts a slice of chat.Model to a slice of ModelResponse DTOs.
func ToModelResponses(models []*chat.Model) []ModelResponse {
	if models == nil {
		return []ModelResponse{}
	}
